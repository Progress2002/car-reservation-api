...
RSpec.describe Reservation, type: :model do
  ...
  let(:car) { Car.create(user_id: user.id, name: 'Honda', image: 'https://imageio.forbes.com/specials-images/imageserve/5d35eacaf1176b0008974b54/0x0.jpg?format=jpg&crop=4560,2565,x790,y784,safe&width=1200', description: 'Good car', model: '2023', price: 23_000.0) }
  subject do
